...
- **Email:** `tolgay@stateful.art` with subject prefix `[interpose-security]`
- **GitHub Private Vulnerability Reporting:** click "Report a vulnerability" on this repo (`interposehq/interpose-releases` → Security tab → Advisories → New draft). GitHub keeps the report private between you and the maintainer.
