...
See [`LICENSE.md`](LICENSE.md). interpose is **proprietary software** distributed under a custom license: **free for personal and non-commercial use; commercial deployment requires a separate license** (contact via the email in `LICENSE.md`).
